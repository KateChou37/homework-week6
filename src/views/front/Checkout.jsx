...
function Checkout() {
  ...
  useEffect(() => {
    ...
    const getCart = async () => {
      try {
        ...
        // 修正 2: 統一使用 response 這個變數名稱
        (console.log(response.data.data), setCart(response.data.data));
      } catch (error) {
  ...
  const addCart = async (id, qty = 1) => {
    ...
    try {
      ...
      // 更新狀態
      (console.log(response2.data.data), setCart(response2.data.data));
    } catch (error) {
      console.log(error.response);
    } finally {
                ...
                <td>
                  <div className="btn-group btn-group-sm">
                    ...
                    <button
                      ...
                      disable={loadingCartId === product.id}
                    >
